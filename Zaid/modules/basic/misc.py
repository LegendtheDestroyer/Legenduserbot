...
alive_logo = ALIVE_PIC or "https://telegra.ph/file/e47dec752f401ca448052.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](https://t.me/TitanBotStore)\n"
        f"├• **¢нαииєℓ**: [Click](https://t.me/TitanBotStore)\n"
        f"└• **яєρσ**: [Click](https://github.com/LegendtheDestroyer/Legenduserbot)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/LegendtheDestroyer/Legenduserbot/\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://github.com/LegendtheDestroyer/Legenduserbot")
